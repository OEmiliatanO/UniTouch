...
class SSVTPDataset(torch.utils.data.Dataset):
    def __init__(self, touch_csv_file, transform=None):
        self.data = pd.read_csv(touch_csv_file)
...
class SSVTPPairedDataset(torch.utils.data.Dataset):
